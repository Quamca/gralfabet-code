...
export function ResultScreen({ results, onPlayAgain, onExit }: Props): React.ReactElement {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={hasCollected ? styles.buttonRow : styles.buttonCenter}>
        {hasCollected && (
...
const styles = StyleSheet.create({
  ...
  buttonRow:     { flexDirection: 'row', justifyContent: 'center', gap: 32, paddingVertical: 20 },
  buttonCenter:  { alignItems: 'center', paddingVertical: 20 },
