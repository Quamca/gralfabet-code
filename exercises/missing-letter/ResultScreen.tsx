...
const styles = StyleSheet.create({
  ...
  card:         { backgroundColor: CORRECT_BG, borderRadius: 16, paddingVertical: 12, paddingHorizontal: 12, alignItems: 'center', borderWidth: 2, borderColor: CORRECT_BORDER, minWidth: '42%' },
  cardImg:      { width: 80, height: 80, resizeMode: 'contain' },
  placeholder:  { width: 80, height: 80, backgroundColor: '#B0BEC5', borderRadius: 8 },
  label:        { fontSize: 18, fontWeight: 'bold', color: '#333', marginTop: 8 },
